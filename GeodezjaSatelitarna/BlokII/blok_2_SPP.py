...
satelity = {
    ...
    # Zastąpiony G15, który był pod horyzontem
    "G18": {
        't': 11700,
        'delta_t': 15,
        'delta_t_s': -649.180043,
        'P': 24799343.752,
        'X': np.array([
            [-6334.280929, -13789.729385,  21809.920344],
            [-4397.381395, -15301.329448,  21250.612463],
            [-2605.386406, -16859.997019,  20325.353243]
        ])
    },
    "G30": {
        't': 11700,
