...
for name, sat in spp.sats.items():
    ...
    print(sat.name, f"{e_S_deg}")

"""Jeden z satelitów ma ujemny kąt inklinacji
Należy go wykluczyć i zastąpić satelitą, który będzie nad horyzontem
Inaczej pomiar nie ma sensu logicznego"""
