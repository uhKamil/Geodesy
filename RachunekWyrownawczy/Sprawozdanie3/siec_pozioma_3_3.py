...
d07 = np.sqrt(deltax07 ** 2 + deltay07 ** 2)  # d103-104
...
# Wyrównanie
# Macierz A - dx101, dy101, dx102, dy102, dx103, dy103, dx104, dy104, dz
A = np.array([[-deltax03 / d03, -deltay03 / d03, 0, 0, 0, 0, deltax03 / d03, deltay03 / d03, 0], # v_d3
              [-deltax04 / d04, -deltay04 / d04, 0, 0, deltax04 / d04, deltay04 / d04, 0, 0, 0], # v_d4
              [0, 0, -deltax05 / d05, -deltay05 / d05, deltax05 / d05, deltay05 / d05, 0, 0, 0], # v_d5
              [deltax06 / d06, deltay06 / d06, -deltax06 / d06, -deltay06 / d06, 0, 0, 0, 0, 0], # v_d6
              [0, 0, 0, 0, -deltax07 / d07, -deltay07 / d07, deltax07 / d07, deltay07 / d07, 0], # v_d7
              [-deltay03 / d03 ** 2, deltax03 / d03 ** 2, 0, 0, -deltay07 / d07 ** 2, deltax07 / d07 ** 2,
               deltay07 / d07 ** 2 - deltay03 / d03 ** 2, -deltax07 / d07 ** 2 - (-deltax03 / d03 ** 2), 0], # v_alfa3
              [-deltay04 / d04 ** 2, deltax04 / d04 ** 2, -deltay05 / d05 ** 2, deltax05 / d05 ** 2, deltay05 / d05 ** 2 - deltay04 / d04 ** 2,
               -deltax05 / d05 ** 2 - (-deltax04 / d04 ** 2), 0, 0, 0], # v_alfa5
              [-deltay06 / d06 ** 2, deltax06 / d06 ** 2, deltay06 / d06 ** 2 - deltay05 / d05 ** 2, -deltax06 / d06 ** 2 - (-deltax05 / d05 ** 2),
               -deltay05 / d05 ** 2, deltax05 / d05 ** 2, 0, 0, 0], # v_alfa6
              [deltay06 / d06 ** 2, -deltax06 / d06 ** 2, -deltay06 / d06 ** 2, deltax06 / d06 ** 2, 0, 0, 0, 0, -1], # v_k102
              [deltay04 / d04 ** 2, -deltax04 / d04 ** 2, 0, 0, -deltay04 / d04 ** 2, deltax04 / d04 ** 2, 0, 0, -1], # v_k103
              [deltay03 / d03 ** 2, -deltax03 / d03 ** 2, 0, 0, 0, 0, -deltay03 / d03 ** 2, deltax03 / d03 ** 2, -1], # v_k104
              [1, 0, 0, 0, 0, 0, 0, 0, 0], # v_x101
              [0, 1, 0, 0, 0, 0, 0, 0, 0], # v_y101
              [0, 0, 0, 0, 0, 0, 1, 0, 0], # v_x104
              [0, 0, 0, 0, 0, 0, 0, 1, 0]])  # v_y104
...
# Macierz wag
m0_3 = 0.005 + 0.005 * np.sqrt(d3 / 1000)
...
p0_3, p1, p2, p3, p4, p5 = m0_3 ** -2, m1 ** -2, m2 ** -2, m3 ** -2, m4 ** -2, m5 ** -2
p6, p7, p8, p9, p10 = m6 ** -2, m7 ** -2, m8 ** -2, m9 ** -2, m10 ** -2
p11, p12, p13, p14 = mx_101 ** -2, my_101 ** -2, mx_104 ** -2, my_104 ** -2

P = np.diag([p0_3, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14])
